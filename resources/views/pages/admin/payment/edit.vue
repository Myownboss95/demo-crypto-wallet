...
// console.log(props.payment.status)
  const form = useForm({
    ...
    start_bonus: props.payment?.start_bonus,
    featured: props.payment?.featured,
    min_withdrawal: props.payment?.min_withdrawal
  });
