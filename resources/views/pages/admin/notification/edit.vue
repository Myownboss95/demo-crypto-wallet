<template>
  <Head title="Edit Notifications" />
  <breadcrumb
    title="Edit Notifications"
    :crumbs="['Dashboard', 'Messages', 'Notification']"
  />
    ...
    <div class="card shadow-lg radius-20">
      <div class="card-body">
        ...
        <div class="mt-3 mb-3">
          ...
          >
            <ButtonLoader text="Update Notification" :loading="form.processing" />
          </FormButton>
        </form>
      </div>
    </div>
...
const props = defineProps({
  ...
  const form = useForm({
    ...
    status: props.notification?.status ||true,
  });
  const updateNotification = (_) => {
