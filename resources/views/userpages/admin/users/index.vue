        ...
        <div class="card-body">
          <div class="row align-items-center">
            ...
            <div class="col-xl-2 col-lg-3 col-sm-4 col-6 mb-3 text-lg-center">
              <small class="mb-2 d-block font-size-12 fw-bold">Wallet </small>
              <span class="font-size-12">
                <InertiaLink
                  :href="route('admin.users.wallet', user.id)"
            ...
            <div class="col-xl-2 col-lg-6 col-sm-4 mb-sm-3 mb-3">
              <small class="mb-2 d-block font-size-12 fw-bold">Contact</small>
                ...
                <div class="dropdown ms-4">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    <inertia-link
                      ...
                      as="button"
                      method="post"
                      :href="route('login-as', user.id)"
                      >Login As</inertia-link
                    >
