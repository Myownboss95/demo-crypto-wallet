<template>
  ...
  <breadcrumb
    title="Trade Bots"
    :crumbs="['Dashboard', 'Trading', 'Trade Bots', 'Link']"
  />
            ...
            <div class="p-2">
              ...
              <div class="mt-4 pt-2 text-muted">
                <p class="mb-3 font-size-12">
                  ...
                  Can generate <strong>{{ bot.trades_per_day }}</strong> Trades
                  a day.
                </p>
                <p class="mb-3 font-size-12">
                  <!-- <i class="mdi mdi-check-circle text-secondary font-size-18 me-2"></i> -->
                  Can manage profit percentage up to
                  <strong>{{ bot.profit_percentage }}%</strong> per trade.
                </p>
                <!-- <p class="mb-3 font-size-12">
                                <i class="mdi mdi-check-circle text-secondary font-size-18 me-2"></i>
