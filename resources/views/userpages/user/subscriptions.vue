      ...
      <div class="card mb-xl-0 shadow-lg">
        <div class="card-body">
          <div class="p-2">
            ...
            <h5 class="mt-3">
              {{ format_money(plan.min_investment) }}
            ...
            <div class="mt-4 pt-2 text-muted">
              <p class="mb-3 font-size-12">
                <i
                  class="mdi mdi-check-circle text-secondary font-size-18 me-2"
                ></i>
              ...
              <p
                class="mb-3 font-size-12"
                v-for="(feature, fkey) in plan.features"
                :key="fkey"
              >
                <i
                  class="mdi mdi-check-circle text-secondary font-size-18 me-2"
            ...
            <div class="mt-4 pt-2">
              <FormButton
                ...
                @button-clicked="subscribe(plan.id)"
              >
