<template>
  <Head title="Send" />
  <breadcrumb title="Send" :crumbs="['Dashboard', 'Send Crypto']" />
          ...
          <div class="px-3">
            <div class="">
              ...
              <ul>
                ...
                <li>
                  Enter Recipient's wallet address. Make sure your address type
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <FormButton
                ...
                @button-clicked="send"
              >
                <ButtonLoader text="Send" :loading="form.processing" />
              </FormButton>
            </div>
          </div>
        </div>
